...
/*          std::cout << "i_value_initial";
          std::cout << i << " ";
          std::cout << "\n"; 
          std::cout << "pop_i_initial";
          std::cout << cal_i_pop_present << " ";
          std::cout << "\n";
          std::cout << "pop_6_i";
          std::cout << population[6][i] << " ";
          std::cout << "\n";
          ...
          std::cout << "\n";
*/ 
    //while ( (2500-cal_i_pop_present) > 0 ) {
...
/*          std::cout << "i_loop";
          ...
          std::cout << population[6][i] << " ";
          std::cout << "\n";
          std::cout << "pop_6_i_diff";
          std::cout << population[6][i+diff] << " ";
          std::cout << "\n";
 */
        if (population[6][i] > 0) {
          for (int ispecies=0; ispecies < MAX_SPECIES; ispecies++) {
          ...
          //cal_i_pop_present = cal_i_pop_present + 1;
          lck_cal_i_pop_present = population[5][j] +population[6][j]+population[7][j]+population[10][j]+population[11][j]+population[12][j]+population[13][j]+population[18][j]+population[19][j]+population[20][j]+population[22][j]+population[23][j]+population[24][j]+population[25][j]+population[29][j]+population[30][j]+population[31][j]+population[8][j]+population[33][j]+population[34][j];
          cal_i_pop_present = population[5][j] +population[6][j]+population[7][j]+population[10][j]+population[11][j]+population[12][j]+population[13][j]+population[24][j]+population[29][j]+population[30][j]+population[31][j]+population[33][j];
        } else { 
    ...
    while ((40-cal_i_pop_present) > 0 && (2500-lck_cal_i_pop_present) > 0) {
        if (population[7][i] > 0) {
          ...
          lck_cal_i_pop_present = population[5][j] +population[6][j]+population[7][j]+population[10][j]+population[11][j]+population[12][j]+population[13][j]+population[18][j]+population[19][j]+population[20][j]+population[22][j]+population[23][j]+population[24][j]+population[25][j]+population[29][j]+population[30][j]+population[31][j]+population[8][j]+population[33][j]+population[34][j];
          cal_i_pop_present = population[5][j] +population[6][j]+population[7][j]+population[10][j]+population[11][j]+population[12][j]+population[13][j]+population[24][j]+population[29][j]+population[30][j]+population[31][j]+population[33][j];
        //cal_i_pop_present = population[6][j] +population[17][j]; //+population[7][pp+diff]+population[10][pp+diff]+population[11][pp+diff]+population[12][pp+diff]+population[13][pp+diff]; //+population[16][pp+diff]+population[17][pp+diff]+population[19][pp+diff]+population[21][pp+diff]+population[22][pp+diff]+population[23][pp+diff]+population[24][pp+diff];
        } else { 
          break;
       }
   }
    ...
    //while (((250-cal_i_pop_present_b_vav_prime) > 0) && ((2500-cal_i_pop_present) >0)) {
...
/*    std::cout << "i_value_initial";
    ...
    std::cout << "\n";
    std::cout << "pop_32_i";
    std::cout << population[32][i] << " ";
    std::cout << "\n";
    std::cout << "pop_32_i_diff";
    std::cout << population[32][i+diff] << " ";
    std::cout << "\n";
    std::cout << "pop_i";
    std::cout << cal_i_pop_present_b_vav_prime << " ";
    std::cout << "\n";*/
    while ((250-cal_i_pop_present_b_vav_prime) > 0 ) {
/*        std::cout << "i_loop";
        std::cout << "\n";*/
