...
void AppInbDiff::init_app()
{
  ...
  if (flagall) error->all(FLERR,"One or more sites have invalid values");
    // Initialze total number of pVav1
...
// update number of pVav1 based on the reaction chosen
  ...
  if (which==37) {
    ...
    lck_cal_i_pop_present = population[5][j] +population[6][j]+population[7][j]+population[10][j]+population[11][j]+population[12][j]+population[13][j]+population[18][j]+population[19][j]+population[20][j]+population[22][j]+population[23][j]+population[24][j]+population[25][j]+population[29][j]+population[30][j]+population[31][j]+population[8][j]+population[33][j]+population[34][j]+population[24][j]+population[33][j];
