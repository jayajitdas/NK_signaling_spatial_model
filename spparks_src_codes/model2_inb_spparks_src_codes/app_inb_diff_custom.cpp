  ...
  AppInbDiff(spk,narg,arg)
{
  ...
  if (narg != 7) error->all(FLERR,"Illegal app_style command");
...
double AppInbDiffCustom::custom_multiplier(int i, int rstyle, int which, int jpartner)
{
   ...
   if (which==2) { // Diffusion: Activating ligands
     if(population[26][jpartner] != 0) {
       int ar_ligand_fill_ahead = population[0][jpartner]+ population[17][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
     ...
     if(population[26][jpartner] != 0) {
       int u_act_fill_ahead = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
     ...
     if(population[26][jpartner] != 0) {
       int ir_inb = population[19][i] +population[20][i]+population[22][i]+population[23][i]+population[24][i]+population[25][i]+population[33][i]+population[34][i];
       int u_sfk_fill_ahead = population[8][jpartner]+population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
       if (ir_inb <= bir_conc) {
     ...
     if(population[26][jpartner] != 0) {
       int micro_inb = population[19][i] +population[20][i]+population[22][i]+population[23][i]+population[24][i]+population[25][i]+population[33][i]+population[34][i];
       int micro_inb_fill_ahead = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
     ...
     if(population[26][jpartner] != 0) {
       int ir_ligand_fill_ahead = population[0][jpartner]+population[17][jpartner] + population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
;
    ...
    if ( (population[1][jpartner] != 0) && (population[1][i] != 0 )) {
      ...
      if (energy_voxel == 0 && energy_nbr_voxel == 0) {
       ...
       int lck_pot_u_act_fill_ahead = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
    ...
    if ( (population[1][jpartner] != 0) && (population[1][i] != 0 )) {
      ...
      if (energy_voxel_vav_prime == 0 && energy_nbr_voxel_vav_prime == 0) {
       ...
       int lck_pot_u_act_fill_ahead_vav_prime_ar = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
...
// centrial movement
        ...
        int lck_micro_act_fill_ahead = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
...
// centrial movement
        ...
        int lck_micro_vav_prime_ar_ar_fill_ahead = population[5][jpartner]+population[6][jpartner]+population[7][jpartner]+population[10][jpartner]+population[11][jpartner]+population[12][jpartner]+population[13][jpartner]+population[18][jpartner]+population[19][jpartner] +population[20][jpartner]+population[22][jpartner]+population[23][jpartner]+population[24][jpartner]+population[25][jpartner]+population[29][jpartner]+population[30][jpartner]+population[31][jpartner]+population[8][jpartner]+population[33][jpartner]+population[34][jpartner]+population[24][jpartner]+population[33][jpartner];
 
// check the AR vacancy for nearest nbr voxel
